...
// Build the uploaded menu background safely. The build must not fail just
// because the optional background asset is missing or malformed.
...
const backgroundCss = hasBackground
  ? "body{background:linear-gradient(rgba(8,14,9,.66),rgba(8,14,9,.82)),url('menu-bg.webp') center center/cover fixed!important;color:#f7faf5!important}"
