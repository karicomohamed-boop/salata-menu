...
// Keep the menu background self-contained in the generated HTML. This avoids
// relying on a generated/static asset surviving a Vercel build and prevents
// the background from disappearing after a deployment or cache refresh.
const backgroundCss = hasBackground
  ? `body{background-image:linear-gradient(rgba(8,14,9,.66),rgba(8,14,9,.82)),url("data:image/webp;base64,${backgroundBase64}")!important;background-position:center center!important;background-size:cover!important;background-repeat:no-repeat!important;background-attachment:fixed!important;background-color:#101810!important;color:#f7faf5!important}`
  : "body{background-image:linear-gradient(180deg,#f7fbf4 0%,#eef6ea 100%)!important;background-color:#eef6ea!important}";
...
console.log('SALATA build completed successfully. Background:', hasBackground ? 'enabled-inline-asset' : 'fallback');
