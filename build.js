...
// Always replace generated theme so an old generated CSS block cannot survive a rebuild.
...
const backgroundLayer = hasBackground
  ? `html:before{content:"";position:fixed;inset:0;z-index:0;pointer-events:none;background-image:linear-gradient(rgba(8,14,9,.22),rgba(8,14,9,.42)),url("/menu-bg.webp?v=${backgroundVersion}");background-position:center center;background-size:cover;background-repeat:no-repeat}html,body{background:transparent!important}`
