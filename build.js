...
try {
  if (fs.existsSync('menu-bg.b64')) {
    ...
    if (raw) {
      ...
      // A valid WebP starts with RIFF and contains WEBP at bytes 8-11.
...
// Serve the background as a real static asset instead of putting the entire
// image into CSS. This is smaller, cache-safe, and survives Vercel builds.
...
console.log('SALATA build completed successfully. Background:', hasBackground ? 'enabled-static-asset' : 'fallback');
